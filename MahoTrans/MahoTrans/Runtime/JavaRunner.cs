...
public class JavaRunner
{
    ...
    private static void StepInternal(JavaThread thread, JvmState state)
    {
        ...
        switch (instr.Opcode)
        {
            ...
            {
                state.Heap.PushClassConstant(frame, args);
                pointer++;
                break;
            }
            case JavaOpcode.iload:
            {
                frame.PushFromLocal((int)args, false);
                pointer++;
                break;
            }
            case JavaOpcode.lload:
            {
                frame.PushFromLocal((int)args, true);
                pointer++;
                break;
            }
            ...
            case JavaOpcode.iload_0:
                frame.PushFromLocal(0, false);
                pointer++;
                break;
            case JavaOpcode.iload_1:
                frame.PushFromLocal(1, false);
                pointer++;
                break;
            case JavaOpcode.iload_2:
                frame.PushFromLocal(2, false);
                pointer++;
                break;
            case JavaOpcode.iload_3:
                frame.PushFromLocal(3, false);
                pointer++;
                break;
            case JavaOpcode.lload_0:
                frame.PushFromLocal(0, true);
                pointer++;
                break;
            case JavaOpcode.lload_1:
                frame.PushFromLocal(1, true);
                pointer++;
                break;
            case JavaOpcode.lload_2:
                frame.PushFromLocal(2, true);
                pointer++;
                break;
            case JavaOpcode.lload_3:
                frame.PushFromLocal(3, true);
                pointer++;
                break;
            ...
            case JavaOpcode.dup_x1:
            {
                ...
                var v2 = frame.Pop();
                // no checks
                frame.PushUnchecked(v1, false);
                frame.PushUnchecked(v2, false);
                frame.PushUnchecked(v1, false);
                pointer++;
                break;
            }
            ...
            case JavaOpcode.newobject:
            {
                ...
                var r = state.Heap.AllocateObject(type);
            ...
            case JavaOpcode.newarray:
            {
                ...
                frame.PushReference(state.Heap.AllocateArray((ArrayType)args, len));
                pointer++;
                break;
            }
            ...
            {
                var arr = state.Heap.Resolve<java.lang.Array>(frame.PopReference());
            ...
            case JavaOpcode.athrow:
            {
                ...
                if (ex.IsNull)
                    state.Heap.Throw<NullPointerException>();
                else
            ...
            case JavaOpcode.checkcast:
            {
                ...
                else if (state.Heap.ResolveObject(obj).JavaClass.Is(type))
                {
                    // ok
                }
                else
                {
                    state.Heap.Throw<ClassCastException>();
                }
            ...
            case JavaOpcode.instanceof:
            {
                ...
                if (obj.IsNull)
                    ...
                    frame.PushInt(state.Heap.ResolveObject(obj).JavaClass.Is(type) ? 1 : 0);
                pointer++;
                break;
            }
            ...
            case JavaOpcode.monitorexit:
            {
                ...
                var obj = state.Heap.ResolveObject(r);
                if (obj.MonitorOwner != thread.ThreadId)
                {
                    state.Heap.Throw<IllegalMonitorStateException>();
                }
                else
                {
