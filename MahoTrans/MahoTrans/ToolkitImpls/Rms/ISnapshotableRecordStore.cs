...
{
    /// <summary>
    ///     Copies content of this record store to <see cref="VirtualRms" />. This must be deep (detached) clone. No futher
    ///     modifications of original store or snapshot must modify another one.
    /// </summary>
